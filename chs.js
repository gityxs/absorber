...
var cnItems = {
    ...
    "A chance to hit an enemy twice": "有机会击中敌人两次",
    "A chance to silence the enemy. Silenced enemies can only perform physical attacks.": "一个让敌人沉默的机会。 被沉默的敌人只能进行物理攻击。",
    "active items = maxitems": "活动项目 = maxitems",
    "Add maximum ammount of items": "添加最大数量的项目",
    ...
    "Added Icons": "添加图标",
    "Added InFight Stats": "添加了 InFight 统计数据",
    "added Items": "添加项目",
    ...
    "block": "堵塞",
    "Blocks a percentage of firedamage": "阻挡一定百分比的火焰伤害",
    "Blocks a percentage of poisondamage": "阻挡一定百分比的毒害",
    "Blue Slime": "蓝色史莱姆",
    "Boar": "公猪",
    "Buffed Hard Turtle": "抛光硬龟",
    "Buffed Slow and Stim": "抛光慢和刺激",
    "Calculation:": "计算：",
    "chance": "机会",
    "Chance to completely avoid the damage of the enemy": "有几率完全避开敌人的伤害",
    "Chance to double the damage": "伤害加倍几率",
    "Chance to increase damage eightfold. Can only occur when super-critical.": "有机会增加八倍的伤害。 只有在超临界时才会发生。",
    "Chance to kill an enemy instantly": "有机会立即杀死敌人",
    "Chance to poison the enemy. Poisoned opponents suffer damage on their turn.": "有几率使敌人中毒。 中毒的对手在他们的回合受到伤害。",
    "Chance to quadruple the damage. Can only occur when critical": "有机会使伤害翻四倍。 只能在关键时发生",
    "Chance to set the opponent on fire. Burning opponents suffer damage on their turn.": "有机会让对手着火。 燃烧的对手在他们的回合受到伤害。",
    "Chance to slow the rate of enemy progress.": "有机会减缓敌人的前进速度。",
    "Chance to stun the enemy. Stunned enemies are unable to attack.": "有机会击晕敌人。 被击晕的敌人无法攻击。",
    "Chances": "机会",
    ...
    "fireresistance": "防火性能",
    "Fixed Dodge": "固定闪避",
    "Fixed Dying on DOT": "固定在 DOT 上死亡",
    "Fixed the big dont-update-numbers-bug": "修复了大的不更新数字错误",
    "Flying Eye": "飞眼",
    "for description.": "用于描述。",
    "for stats.": "统计数据。",
    "Gain:": "获得：",
    "Goblin": "哥布林",
    "Hard": "难的",
    "Hard Turtle": "硬龟",
    "Health": "健康",
    "health = dmg * lifesteal / 100": "健康 = 伤害 * 吸血 / 100",
    "health = health + regeneration": "健康=健康+再生",
    "health = health + regeneration + recovery": "健康=健康+再生+恢复",
    "Health restored at every turn": "每次都恢复健康",
    "Health restored in each second outside of combat": "在战斗之外每秒恢复健康",
    "Hide Finished": "隐藏完成",
    ...
    "Maximum amount of activ items": "活动项目的最大数量",
    "Maximum amount of health. The target dies when it is dropped to 0.": "最大健康量。 目标在下降到 0 时死亡。",
    "maxitems": "最大值",
    ...
    "turn = currentSpeed>=speed": "转=当前速度>=速度",
    "Turtle": "乌龟",
    "Vampire": "吸血鬼",
    "Water Elementar": "水元素",
    "Wind Elementar": "风元素",
